# -*- coding: utf-8 -*-
#
# vininfo documentation build configuration file.
#
...
project = u'vininfo'
copyright = u'2018, Igor `idle sign` Starikov'
...
latex_documents = [
  ('index', 'vininfo.tex', u'vininfo Documentation',
...
man_pages = [
    ('index', 'vininfo', u'vininfo Documentation',
